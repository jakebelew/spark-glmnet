...
import org.apache.spark.ml.classification.{ LogisticRegressionWithCD1, LogisticRegressionWithCDModel, LogisticRegressionWithCDParams }
...
object LogisticRegressionWithCDExample {
  ...
  def main(args: Array[String]) {
    LogisticRegressionWithCDRunner.run("LogisticRegressionWithCDExample", new LogisticRegressionWithCD1(""), 1, args)
  }
}

//object LogisticRegressionWithCD2Example {
//
//  def main(args: Array[String]) {
//    LogisticRegressionWithCDRunner.run("LogisticRegressionWithCD2Example", new LogisticRegressionWithCD2(""), 2, args)
//  }
//}

private object LogisticRegressionWithCDRunner extends Logging {

  def run(appName: String, lr: Estimator[LogisticRegressionWithCDModel] with LogisticRegressionWithCDParams, optimizerVersion: Int, args: Array[String]) {
