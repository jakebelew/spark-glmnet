...
import org.apache.spark.mllib.linalg.{Vector, DenseVector, SparseVector, Matrix, DenseMatrix, SparseMatrix}

import org.apache.spark.Logging

//Temporarily from org.apache.spark.mllib.linalg.BLAS to allow more logging and experimentation with BLAS levels using Java or Native BLAS implementations
...
private[spark] object BLAS extends Serializable with Logging {
  ...
  private def f2jBLAS: NetlibBLAS = {
    if (_f2jBLAS == null) {
      ...
      logDebug("f2jBLAS implementation provided by " + _f2jBLAS.getClass())
    }
    _f2jBLAS
  }
  ...
  private def nativeBLAS: NetlibBLAS = {
    if (_nativeBLAS == null) {
      ...
      logDebug("nativeBLAS implementation provided by " + _nativeBLAS.getClass())      
    }
    _nativeBLAS
  }
